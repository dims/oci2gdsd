...
kind: Job
metadata:
  name: oci2gdsd-sglang-daemon-client
  namespace: __E2E_NAMESPACE__
  labels:
    app.kubernetes.io/name: oci2gdsd-sglang-daemon-client
spec:
  backoffLimit: 0
  ...
  template:
    ...
    spec:
      ...
      - name: daemon-client-script
        configMap:
          name: sglang-daemon-client-script
          defaultMode: 0555
      ...
      - name: host-cuda-include
        hostPath:
          ...
          type: Directory
      containers:
      - name: sglang-daemon-client
        image: __SGLANG_IMAGE__
        ...
        - |
          set -eu
          python3 /scripts/sglang_daemon_client.py
        env:
        - name: MODEL_REF
          value: "__MODEL_REF__"
        - name: MODEL_ID
        ...
        - name: PYTHONPATH
          value: "/scripts"
        - name: SGLANG_PRIVATE_LOADER_SCRIPT_PATH
          value: "__SGLANG_PRIVATE_LOADER_SCRIPT_PATH__"
