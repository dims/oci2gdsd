...
QUICK_EXAMPLE_LEASE_HOLDER="${QUICK_EXAMPLE_LEASE_HOLDER:-verify-host-qwen-smoke}"
...
run_host_probe() {
  ...
  local native_cpp="${REPO_ROOT}/platform/k3s/workloads/pytorch/qwen-hello/native/oci2gds_torch_native.cpp"
